    ...
    public:
        ...
        virtual void setContent(const string& content) {
            ...
            if (transform_ && font_ && font_->get()) {
                ...
                if (pixelFormat_ != 0) {
                    SDL_Surface* pixelFormattedSurface = SDL_ConvertSurfaceFormat(surface, pixelFormat_, 0);
        ...
        void render() override {
            if (texture_) {
                ...
                if (outlineFont_ && outlineTexture_) {
                    ...
                    angle = transform_->rotation.getAngle();
                    SDL_RenderCopyEx(getriebe.sdl_renderer(), outlineTexture_, NULL, &destRectangle_, angle, NULL, SDL_FLIP_NONE);
                }
                SDL_RenderCopyEx(getriebe.sdl_renderer(), texture_, NULL, &destRectangle_, angle, NULL, SDL_FLIP_NONE);
            }
        }
    };
